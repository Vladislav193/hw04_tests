...
class PostCreateFormTest(TestCase):
    ...
    def new_post_create_form(self):
        ...
        self.assertRedirects(response, reverse('posts:profile', kwargs={'username':'Test_name'}))
    ...
    def create_post_form(self):
        ...
        self.assertRedirects(response, reverse('posts:detail', kwargs={'post_id': f'{self.post.pk}'}))
